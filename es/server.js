 ...
 */
export var InversifyRestifyServer = (function () {
    /**
     * Wrapper for the restify server.
     *
    ...
    InversifyRestifyServer.prototype.registerControllers = function () {
        var _this = this;
        var controllers = this.container.getAll(TYPE.Controller);
    ...
    InversifyRestifyServer.prototype.handlerFactory = function (controllerName, key) {
        ...
        return function (req, res, next) {
            var result = _this.container.getNamed(TYPE.Controller, controllerName)[key](req, res, next);
